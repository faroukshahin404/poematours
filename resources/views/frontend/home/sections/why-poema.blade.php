<section class="section home-why-poema" aria-labelledby="home-why-poema-heading">
    <div class="container">
        <header class="home-section-head home-section-head--editorial home-why-poema__intro home-reveal-item" style="--home-reveal-item-delay: 0ms;">
        ...
        <ul class="home-why-poema__grid" role="list">
            @foreach (($homeWhyPoema['items'] ?? []) as $item)
                <li class="home-why-poema__item home-reveal-item" style="--home-reveal-item-delay: {{ 70 + ($loop->index * 90) }}ms;">
