            ...
            <div class="auth-card auth-card--compact">
                <div class="auth-card__layout">
                    <div class="auth-card__intro">
                        ...
                        <ul class="auth-card__highlights" aria-label="Recovery process">
                            <li>Secure reset instructions sent to your inbox.</li>
                            <li>Use the link to create a new password safely.</li>
                            <li>Return to your account with full access.</li>
                        </ul>
                    </div>
