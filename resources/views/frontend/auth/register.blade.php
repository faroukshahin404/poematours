            ...
            <div class="auth-card">
                <div class="auth-card__layout">
                    <div class="auth-card__intro">
                        ...
                        <ul class="auth-card__highlights" aria-label="Membership value">
                            <li>Build personalized travel plans faster.</li>
                            <li>Keep your interests and trip preferences saved.</li>
                            <li>Get curated ideas inspired by your style.</li>
                        </ul>
                    </div>
