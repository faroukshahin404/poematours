...
const form = useForm({ destination_id: '', name: {}, description: {}, image: null });
...
<template>
    <div>
        ...
        <div class="mb-6"><Link href="/admin/activities" class="text-sm font-medium text-sky-700">← Activities</Link><h1 class="mt-2 text-xl font-semibold text-slate-900">Add activity</h1></div>
        <form class="max-w-3xl space-y-6 rounded-xl border border-slate-200 bg-white p-6 shadow-sm" @submit.prevent="submit">
            ...
            <FileInput label="Activity image" @update:model-value="form.image = $event" />
