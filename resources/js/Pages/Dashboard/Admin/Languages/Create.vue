...
const isFirstLanguage = computed(() => props.languageCount === 0);
...
<template>
    <div>
        ...
        <div class="mb-6">
            ...
            <h1 class="mt-2 text-xl font-semibold text-slate-900">Add language</h1>
        ...
        >
            ...
            <div v-if="isFirstLanguage" class="rounded-lg border border-sky-100 bg-sky-50 px-3 py-2 text-sm text-sky-900">
                The first language is always set as the default site language.
            </div>
