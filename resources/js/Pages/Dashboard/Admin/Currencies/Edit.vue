...
const isOnlyCurrency = computed(() => props.currencyCount === 1);
...
function submit() {
    form.put(`/admin/currencies/${props.currency.id}`, {
        preserveScroll: true,
    });
}
</script>
...
<template>
    <div>
        ...
        <div class="mb-6">
            ...
            <h1 class="mt-2 text-xl font-semibold text-slate-900">Edit currency</h1>
        ...
        >
            ...
            <div v-if="isOnlyCurrency" class="rounded-lg border border-sky-100 bg-sky-50 px-3 py-2 text-sm text-sky-900">
                This is the only currency; it must remain the default.
            </div>
