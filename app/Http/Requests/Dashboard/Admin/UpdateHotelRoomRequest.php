...
class UpdateHotelRoomRequest extends FormRequest
{
    ...
    /**
     * @return array{slug: string, hotel_id: int, name: array<string, string>, capacity: int, area: float|null, base_price: float, single_supplement: float, remove_media_ids: array<int, int>}
     */
