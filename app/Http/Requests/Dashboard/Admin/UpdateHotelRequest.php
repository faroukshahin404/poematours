...
class UpdateHotelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            'slug' => ['required', 'string', 'max:255', Rule::unique('hotels', 'slug')->ignore($hotel->id)],
    ...
    /**
     * @return array{slug: string, destination_id: int, stars: int, name: array<string, string>, description: array<string, string>, remove_media_ids: array<int, int>}
     */
