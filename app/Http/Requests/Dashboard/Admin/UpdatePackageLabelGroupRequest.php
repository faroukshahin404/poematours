...
class UpdatePackageLabelGroupRequest extends FormRequest
{
    ...
    {
        $default = Language::defaultSlug();
        /** @var PackageLabelGroup $packageLabelGroup */
        $packageLabelGroup = $this->route('package_label_group');
        ...
        $rules = [
            'slug' => [
                ...
                'string',
                'max:255',
                Rule::unique('package_label_groups', 'slug')->ignore($packageLabelGroup->id),
            ],
            'name' => ['required', 'array'],
